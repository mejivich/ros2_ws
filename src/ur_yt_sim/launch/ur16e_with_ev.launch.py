...
def launch_setup(context, *args, **kwargs):
    ...
    # ✅ Use empty world with factory support
    world_file = PathJoinSubstitution([FindPackageShare("gazebo_ros"), "worlds", "empty_with_factory.world"])
    ...
    # ✅ Spawn robot AFTER ros2_control is live
    ...
    # ✅ MoveIt — robot_description already loaded
    ...
    moveit_launch_delayed = TimerAction(period=5.0, actions=[moveit_launch])
...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument("runtime_config_package", default_value="ur_yt_sim"),
        DeclareLaunchArgument("controllers_file", default_value="ur16e_controllers.yaml"),
        ...
        DeclareLaunchArgument("description_file", default_value="ur16e_with_evcharger.urdf.xacro"),  # ✅ Updated
